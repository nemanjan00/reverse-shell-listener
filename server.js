...
startTcp();
startTls();
// Share the API server's HTTP connection handler when no dedicated proxy port
// is configured; otherwise the proxy listens on PROXY_PORT.
startProxy(config.PROXY_PORT ? null : server);
